...
describe('[design-system/actions/libraryItemsActions]', () => {
  ...
  describe('actionAddItem', () => {
    ...
    it('should pass type ACTION_LIBRARY_ITEMS_ADDED with item object', () => {
      // having
      const item = { type: 'def' };
  ...
  describe('actionDeleteItem', () => {
    ...
    it('should pass type ACTION_LIBRARY_ITEMS_DELETED with item object', () => {
      // having
      const item = { id: 1 };
  ...
  describe('actionUpdateItem', () => {
    ...
    it('should pass type ACTION_LIBRARY_ITEMS_UPDATED with item object', () => {
      // having
      const item = {};
    ...
    describe('actionUpdateItem2', () => {
      it('should pass type ACTION_LIBRARY_ITEMS_UPDATED with item object2', () => {
